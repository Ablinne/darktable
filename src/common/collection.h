...
typedef enum dt_collection_filter_comparator_t
{
  ...
  COLLECTION_FILTER_HISTORY_ALTERED = 1 << 3,   // show only altered images (History non-empty and edited)
  COLLECTION_FILTER_HISTORY_AUTOMATIC = 1 << 4, // show only unaltered images (History only automatic presets)
  COLLECTION_FILTER_HISTORY_EMPTY = 1 << 5,     // show only images with empty history
